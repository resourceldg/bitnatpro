...
urlpatterns = [
    ...
    url(r'^posicionamiento_web/gracias/$', views.gracias, name='gracias'),#dry(dont repeat yourself): me estoy repitiendo (SOLUCION: APRENDER A USAR REGEX EN PATRONES URL)
...
#LANDING PAGES
    ...
    url(r'^posicionamiento_web/$', views.Posicionamiento_web.as_view(), name='posicionamiento-web'),
